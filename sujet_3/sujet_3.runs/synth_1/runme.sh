...
HD_PWD='C:/Users/_index/Documents/Programming/projet-vhdl/sujet_3/sujet_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log compteur_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source compteur_led.tcl
