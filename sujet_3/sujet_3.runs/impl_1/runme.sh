...
HD_PWD='C:/Users/_index/Documents/Programming/projet-vhdl/sujet_3/sujet_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log compteur_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source compteur_led.tcl -notrace
