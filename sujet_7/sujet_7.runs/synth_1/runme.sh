...
HD_PWD='C:/Users/_index/Documents/Programming/projet-vhdl/sujet_7/sujet_7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log drapeau.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source drapeau.tcl
