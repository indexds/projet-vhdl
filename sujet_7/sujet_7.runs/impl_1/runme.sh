...
HD_PWD='C:/Users/_index/Documents/Programming/projet-vhdl/sujet_7/sujet_7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log drapeau.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source drapeau.tcl -notrace
