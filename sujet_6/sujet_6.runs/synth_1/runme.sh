...
HD_PWD='C:/Users/_index/Documents/Programming/projet-vhdl/sujet_6/sujet_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chrono.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source chrono.tcl
