...
HD_PWD='C:/Users/_index/Documents/Programming/projet-vhdl/sujet_5/sujet_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log chiffres_differents.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source chiffres_differents.tcl -notrace
