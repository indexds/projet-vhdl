...
HD_PWD='C:/Users/_index/Documents/Programming/projet-vhdl/sujet_5/sujet_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chiffres_differents.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source chiffres_differents.tcl
