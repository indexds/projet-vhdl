...
HD_PWD='C:/Users/_index/Documents/Programming/projet-vhdl/sujet_2/sujet_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chenillard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source chenillard.tcl
