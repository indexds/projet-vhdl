...
HD_PWD='C:/Users/_index/Documents/Programming/projet-vhdl/sujet_2/sujet_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log chenillard.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source chenillard.tcl -notrace
