...
HD_PWD='C:/Users/_index/Documents/Programming/projet-vhdl/sujet_4/sujet_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log chiffre.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source chiffre.tcl -notrace
