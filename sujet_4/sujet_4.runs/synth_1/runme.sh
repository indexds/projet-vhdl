...
HD_PWD='C:/Users/_index/Documents/Programming/projet-vhdl/sujet_4/sujet_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chiffre.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source chiffre.tcl
