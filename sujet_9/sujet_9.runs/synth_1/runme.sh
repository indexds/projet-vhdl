...
HD_PWD='C:/Users/_index/Documents/Programming/projet-vhdl/sujet_9/sujet_9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pong.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pong.tcl
